...
**Camera Control LoRAs for Filmmakers (all ~313MB-2.1GB, in loras/):**
...
## Monitoring & Management Tools (Verda, #106)

**Installed on Verda (95.216.229.236):** Prometheus (:9090), Grafana (:3001), Loki (:3100), cAdvisor (:8081), Promtail, Dry, Verda SDK (`pip install verda`), OpenTofu (`tofu`)
...
**Skills:** `/verda-ssh`, `/verda-status`, `/verda-logs`, `/verda-containers`, `/verda-terraform`, `/verda-open-tofu`, `/verda-prometheus`, `/verda-dry`, `/verda-loki`, `/verda-grafana`, `/verda-monitoring-check`, `/verda-debug-containers`
